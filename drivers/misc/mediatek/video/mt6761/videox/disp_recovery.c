...
#ifdef KCDISP_CUST
		if ((!esd_check_enable)
			||(kdisp_lcm_check_refresh_disable(primary_get_lcm()))) {
#else
		if (!esd_check_enable) {
#endif /* KCDISP_CUST*/
...
#ifdef KCDISP_CUST
	kdisp_lcm_pre_off(primary_get_lcm());
#endif /* KCDISP_CUST*/
...
#ifdef KCDISP_CUST
	kdisp_lcm_post_off(primary_get_lcm());
	kdisp_lcm_pre_on(primary_get_lcm());
#endif /* KCDISP_CUST*/
...
#ifdef KCDISP_CUST
	kdisp_lcm_post_on(primary_get_lcm());
#endif /* KCDISP_CUST*/
