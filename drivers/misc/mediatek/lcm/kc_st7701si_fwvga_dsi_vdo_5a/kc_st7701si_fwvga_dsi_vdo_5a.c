...
static struct LCM_setting_table_V3 init_setting[] = {
	...
	{0x13, 0xC7, 1,  {0x04} },
	{0x13, 0xCC, 1,  {0x10} },
	{0x29, 0xB0, 16, {0x00, 0x08, 0x8F, 0x0C, 0x0F, 0x04, 0x00, 0x07, 0x07, 0x1E, 0x06, 0x54, 0x12, 0x29, 0x31, 0x1F} },
	{0x29, 0xB1, 16, {0x00, 0x08, 0x8E, 0x0C, 0x0F, 0x05, 0x00, 0x07, 0x07, 0x1E, 0x06, 0x54, 0x11, 0x29, 0x31, 0x1F} },
	...
	{0x29, 0xED, 16, {0xFF, 0x45, 0x67, 0xFB, 0x01, 0x2A, 0xFC, 0xFF, 0xFF, 0xCF, 0xA2, 0x10, 0xBF, 0x76, 0x54, 0xFF} },
...
//	int32_t					(*light_led_disp_set_panel)(e_light_main_wled_disp, e_light_lcd_panel);
...
//		panel_detect_status = 0x3A;
		panel_detect_status = 0x5A; //zantei
	}
...
//    kcdisp->light_led_disp_set_panel = NULL;
...
//            kcdisp_data.light_led_disp_set_panel = lp5569_light_led_disp_set_panel;
//            kcdisp_data.light_led_disp_set_panel(LIGHT_MAIN_WLED_LCD_EN, 0);
//        } else if (lv5216_get_board_id()) {
//            kcdisp_data.light_led_disp_set_panel = lv5216_light_led_disp_set_panel;
//            kcdisp_data.light_led_disp_set_panel(LIGHT_MAIN_WLED_LCD_EN, 1);
//        } else {
//            pr_notice("[KCDISP]LCM: failed to detect led driver\n");
            // ret = -ENODEV;
//        }
    }
...
struct LCM_DRIVER kc_st7701si_fwvga_dsi_vdo_5a_lcm_drv = {
	.name = "kc_st7701si_fwvga_dsi_vdo_5a",
